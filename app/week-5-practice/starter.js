    ...
    <div className="p-8 space-y-12">
      ...
      <section className="border p-6 rounded-lg">
        ...
        <div className="space-x-2">
          <button 
          disabled={isDisabled} onClick={() => setCount(count + 1)}
          className="px-4 py-2 bg-blue-500 text-white rounded disabled:bg-gray-300 disabled:cursor-not-allowed">
            Increase
          </button>
          <button disabled={isDisabled} onClick={() => {
            console.log("Current count before decrease:", count);
            setCount(count - 1);
          }}
      ...
      <section className="border p-6 rounded-lg">
        ...
        <button onClick={() => setIsDarkTheme(!isDarkTheme)} className="mt-4 px-4 py-2 bg-purple-500 text-white rounded">
          Toggle Theme
        </button>
      </section>
      ...
      <section className="border p-6 rounded-lg">
        ...
        <div className="space-x-2 mb-4">
          <button onClick={() => filterByCategory("all")} className="px-4 py-2 bg-gray-500 text-white rounded">
            All
          </button>
          <button onClick={() => filterByCategory("electronics")} className="px-4 py-2 bg-green-500 text-white rounded">
            Electronics
          </button>
          <button onClick={() => filterByCategory("furniture")} className="px-4 py-2 bg-green-500 text-white rounded">
            Furniture
          </button>
          <button onClick={() => filterByCategory("stationery")} className="px-4 py-2 bg-green-500 text-white rounded">
            Stationery
          </button>
        </div>
